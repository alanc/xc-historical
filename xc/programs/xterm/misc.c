/*
 *	$XConsortium: misc.c,v 1.55 89/11/13 11:58:55 jim Exp $
 */
...
#ifndef lint
static char rcs_id[] = "$XConsortium: misc.c,v 1.55 89/11/13 11:58:55 jim Exp $";
#endif	/* lint */
...
int (*func)();
{
	...
	*cp = 0;
	...
	case 50:
		SetVTFont (fontMenu_fontescape, True, buf);
		break;
