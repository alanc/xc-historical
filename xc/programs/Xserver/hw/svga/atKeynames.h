 ...
 *       here for SVR4.2 the PC/XT compatible Set1. This set uses 8bit
 *       scancodes. Bit 7 ist set if the key is released. The code E0
 *       switches to a different meaning to add the new MF cursorkeys, while
 *       not breaking old applications. E1 is another special prefix. Since
 *       I assume that there will be further versions of PC/XT scancode
 *       compatible keyboards, we may be in trouble one day.
 *
 ...
 * keyboard sends them as sequence of other scancodes. SOme of them are also
 * used to get a hardwired NumLock key functionality.
 */
