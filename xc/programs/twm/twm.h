...
typedef struct TwmWindow
{
    ...
    ColorPair title;
    unsigned title_top;		/* top color of 3D button */
    unsigned title_bottom;	/* bottom color of 3D button */
    ColorPair iconc;
    unsigned icon_top;		/* top color of 3D button */
    unsigned icon_bottom;	/* bottom color of 3D button */
