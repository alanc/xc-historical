...
Test test[] = {
  ...
  {"-bigostrap100", "Fill 100x100 161x145 opaque stippled trapezoid",
		InitTrapezoids, DoTrapezoids, NullProc, EndTrapezoids,
		XOR,     0,
		{100, 100, "big", NULL, FillOpaqueStippled}},
  ...
  {"-ftext",    "Char in 80-char line (6x13)",
		...
		{80, False, "6x13", NULL}},
#ifdef NOTDEF
  {"-8x13text", "Char in 70-char line (8x13)",
		InitText, DoText, ClearTextWin, EndText,
		XOR, 0,
		{70, False, "8x13", NULL}},
  {"-9x15text", "Char in 60-char line (9x15)",
		InitText, DoText, ClearTextWin, EndText,
		XOR, 0,
		{60, False, "9x15", NULL}},
#endif
  ...
  {"-fitext",   "Char in 80-char image line (6x13)",
		...
		{80, False, "6x13", NULL}},
#ifdef NOTDEF
  {"-8x13itext", "Char in 70-char image line (8x13)",
		InitText, DoImageText, ClearTextWin, EndText,
		NONXOR, 0,
		{70, False, "8x13", NULL}},
  {"-9x15itext", "Char in 60-char image line (9x15)",
		InitText, DoImageText, ClearTextWin, EndText,
		NONXOR, 0,
		{60, False, "9x15", NULL}},
#endif
