...
#ifndef ox_exchange_h
#define ox_exchange_h
...
class RemoteExchange : public Exchange {
public:
    RemoteExchange(
	char* host, ULong port, ULong impl, ULong obj
    );
    RemoteExchange(const RemoteExchange&);
    ~RemoteExchange();
...
static const Long RemoteExchange_narrow_op = -1;
