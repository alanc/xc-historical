...
MIT, DIGITAL AND OLIVETTI DISCLAIM ALL WARRANTIES WITH REGARD TO THIS
 ...
 */
/*
 * HISTORY $Log: XSync.c,v $ Revision 1.1.1.2  1993/05/05  18:00:16
 * Pete_Snider initial rcs submit
 * 
 * 
 * $EndLog$
 */
