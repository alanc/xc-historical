 ...
 * documentation, and that the name Vrije Universiteit or M.I.T. not be used
 * in advertising or publicity pertaining to distribution of the software
 * without specific, written prior permission.  The Vrije Universiteit and
 * M.I.T. make no representations about the suitability of this software for
 * any purpose.  It is provided "as is" without express or implied warranty.
 *
 * THE VRIJE UNIVERSITEIT DISCLAIM ALL WARRANTIES WITH REGARD TO THIS SOFTWARE,
